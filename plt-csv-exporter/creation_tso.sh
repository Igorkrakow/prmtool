...
###PROCCEDURES PAYMENT
###   CREATE PROCEDURE TSO_PAYMENT_CLOSED ###########
log_with_timestamp "CREATE PROCEDURE TSO_PAYMENT_CLOSED"
db2 -td@ -f TSO/SQL/PROCEDURE/PAYMENT/TSO_PAYMENT_CLOSED.SQL| tee -a $logfile
